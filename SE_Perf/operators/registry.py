...
class OperatorRegistry:
    ...
    def create_operator(self, name: str, context: OperatorContext) -> BaseOperator | None:
        """
        创建算子实例
...
def create_operator(name: str, context: OperatorContext) -> BaseOperator | None:
    """
    从全局注册表创建算子实例
    ...
    Returns:
        算子实例或None
    """
    return _global_registry.create_operator(name, context)
